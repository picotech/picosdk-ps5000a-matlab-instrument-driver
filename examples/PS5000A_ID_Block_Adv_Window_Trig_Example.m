...
% trigger on channel A AND channel B. In this example, just channel A is being used.
...
[status.ps5000aSetTriggerChannelConditionsV2] = invoke(triggerGroupObj, 'ps5000aSetTriggerChannelConditionsV2', ChATriggerConditions, info);
...
TriggerDirections(1).direction = ps5000aEnuminfo.enPS5000AThresholdDirection.PS5000A_EXIT;
TriggerDirections(1).mode = ps5000aEnuminfo.enPS5000AThresholdMode.PS5000A_WINDOW;
...
TriggerChannelChannelProperties(1).thresholdLower = 0;
