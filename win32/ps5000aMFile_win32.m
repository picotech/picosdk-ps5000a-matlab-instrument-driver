...
%This function was generated by loadlibrary.m parser version  on Tue Jul  3 12:16:52 2018
...
% PICO_STATUS _stdcall ps5000aGetMininumTimebaseStateless ( int16_t handle , PS5000A_CHANNEL_FLAGS enabledChannelOrPortFlags , uint32_t * timebase , double * timeInterval , PS5000A_DEVICE_RESOLUTION resolution ); 
fcns.name{fcnNum}='ps5000aGetMininumTimebaseStateless'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'enPS5000AChannelFlags', 'uint32Ptr', 'doublePtr', 'enPS5000ADeviceResolution'};fcnNum=fcnNum+1;
